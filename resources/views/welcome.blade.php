...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#pelayanan">Pelayanan</a></li>
                        </ul>
                    ...
                    <div class="owl-carousel owl-banner">
                        <div class="item item-1">
                            <div class="header-text">
                                <h2>SIMAN</h2>
                                <p>Sistem Informasi Manajemen Pemakaman</p>
                                <div class="buttons">
                                    <div class="main-button">
                                        <a href="admin/">Masuk</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="services section" id="pelayanan">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="service-item">
                        <div class="icon">
                            <img src="landingpage/assets/images/service-01.png" alt="online degrees">
                        </div>
                        <div class="main-content">
                            <h4>Pengelolaan Makam</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item">
                        <div class="icon">
                            <img src="landingpage/assets/images/service-02.png" alt="short courses">
                        </div>
                        <div class="main-content">
                            <h4>Informasi Makam</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item">
                        <div class="icon">
                            <img src="landingpage/assets/images/service-03.png" alt="web experts">
                        </div>
                        <div class="main-content">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="main-content">
                            <img src="landingpage/assets/images/member-01.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="main-content">
                            <img src="landingpage/assets/images/member-02.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="main-content">
                            <img src="landingpage/assets/images/member-04.jpg" alt="">
                ...
                <div class="col-lg-7">
                    <div class="owl-carousel owl-testimonials">
                        <div class="item">
                            ...
                            <div class="author">
                                <img src="landingpage/assets/images/testimonial-author.jpg" alt="">
                                <span class="category">Full Stack Master</span>
                                <h4>Claude David</h4>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="item">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="image">
                                    <img src="landingpage/assets/images/event-01.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <ul>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="item">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="image">
                                    <img src="landingpage/assets/images/event-02.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <ul>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="item">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="image">
                                    <img src="landingpage/assets/images/event-03.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <ul>
    ...
    <footer>
        <div class="container">
            <div class="col-lg-12">
                <p>Copyright © 2024 Dinas Perumahan dan Kawasan Permukiman Kabupaten Cianjur</p>
            </div>
        </div>
    </footer>
